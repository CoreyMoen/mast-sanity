 ...
 * A showcase page demonstrating the benefits of using the Mast design system with Sanity CMS
 *
 * Run with: npx tsx scripts/seed-mast-sanity-page.ts
 *
 * Required environment variables:
 * - SANITY_STUDIO_PROJECT_ID: Your Sanity project ID
 * - SANITY_STUDIO_DATASET: Dataset name (usually 'production')
 * - SANITY_API_TOKEN: A Sanity API token with write access
 *   (Create at: https://www.sanity.io/manage/project/<project-id>/api#tokens)
 */
...
dotenv.config({path: path.join(__dirname, '../studio/.env')})

// Check for required token early
if (!process.env.SANITY_API_TOKEN) {
  console.error('\n❌ Error: SANITY_API_TOKEN environment variable is required.')
  console.error('\nTo create a token:')
  console.error(`1. Go to: https://www.sanity.io/manage/project/${process.env.SANITY_STUDIO_PROJECT_ID || 'YOUR_PROJECT'}/api#tokens`)
  console.error('2. Click "Add API token"')
  console.error('3. Give it a name like "Seed Script"')
  console.error('4. Select "Editor" permissions')
  console.error('5. Add the token to your studio/.env file as SANITY_API_TOKEN=your-token')
  console.error('')
  process.exit(1)
}
...
const mastInSanityPage = {
  ...
  pageBuilder: [
    // ========================================================================
    // SECTION 1: Hero - Bold statement with visual
    // ========================================================================
    createSection(
          ...
          [
            createColumn(
              [
                ...
                createHeadingBlock(
                  'Where thoughtful design meets intelligent content',
                  'h1',
                  'inherit',
                  'left'
                ),
    ...
    // ========================================================================
    // SECTION 3: The Solution - Full-width dark moment
    // ========================================================================
    createSection(
      'The Solution',
      [
    ...
    // ========================================================================
    // SECTION 4: Features Grid - Key capabilities
    // ========================================================================
    createSection(
      'Key Capabilities',
      [
    ...
    // ========================================================================
    // SECTION 5: How It Works - Visual workflow
    // ========================================================================
    createSection(
      'How It Works',
      [
    ...
    // ========================================================================
    // SECTION 6: Component Showcase - Tabs with examples
    // ========================================================================
    createSection(
      'Component Showcase',
      [
                          ...
                          [
                            createColumn(
                              [
                                ...
                                createRichTextBlock(
                                  [
                                    'Sections contain rows. Rows contain columns. Columns contain blocks. This hierarchy gives you complete control over layout while maintaining consistency.',
                                    'The 12-column grid adapts to any screen size, with independent controls for desktop, tablet, and mobile layouts.',
                                  ],
                                  'base'
                                ),
                              ],
                              ...
                              [
                                ...
                                createRichTextBlock(
                                  [
                                    ...
                                    'Eyebrows, headings, and body text work together to guide the reader\'s eye through your content.',
                                  ],
                                  'base'
                                ),
                              ],
                      ...
                      content: [
                        createRow(
                          [
                            createColumn(
                              [
                                createHeadingBlock('Engaging Components', 'h4'),
                                createSpacerBlock('4', '2'),
                                createRichTextBlock(
                                  [
                                    'Sliders, tabs, accordions, and modals add interactivity without requiring custom code. Each component is accessible and performant by default.',
                                    'Autoplay, navigation controls, and transition effects are all configurable through the Sanity interface.',
                                  ],
                                  'base'
                                ),
                              ],
