"use strict";
/**
 * anthropic.ts — Anthropic/Claude LLM provider implementation.
 *
 * Uses the Anthropic Messages REST API directly (no SDK) to generate
 * social media captions, rewrite content, and suggest hashtags.
 * Defaults to claude-haiku-4-5-20251001 for cost-effective caption generation.
 */
...
var AnthropicProvider = /** @class */ (function () {
    function AnthropicProvider(apiKey, model) {
        ...
        if (!apiKey) {
            throw new Error("Anthropic API key is required. Provide a valid API key from the Anthropic console.");
        }
        this.apiKey = apiKey;
        this.model = model;
    }
    AnthropicProvider.prototype.callAnthropic = function (systemPrompt_1, userPrompt_1) {
        return __awaiter(this, arguments, void 0, function (systemPrompt, userPrompt, temperature, maxTokens) {
            var messages, response, error_1, errorText, data, _a, textBlock, text;
            var _b, _c;
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 3:
                        error_1 = _d.sent();
                        throw new Error("Anthropic API request failed: ".concat(error_1 instanceof Error ? error_1.message : "Network error"));
                    case 4:
                    ...
                    case 5:
                        errorText = _d.sent();
                        throw new Error("Anthropic API returned status ".concat(response.status, ": ").concat(errorText));
                    case 6:
                        _d.trys.push([6, 8, , 9]);
                    ...
                    case 9:
                        if (data.error) {
                            throw new Error("Anthropic API error: ".concat((_b = data.error.message) !== null && _b !== void 0 ? _b : "Unknown error"));
                        }
                        textBlock = (_c = data.content) === null || _c === void 0 ? void 0 : _c.find(function (block) { return block.type === "text"; });
                        text = textBlock === null || textBlock === void 0 ? void 0 : textBlock.text;
                        if (!text) {
                            throw new Error("Anthropic API returned an empty response. The model may have refused the request.");
                        }
    ...
    AnthropicProvider.prototype.generateCaption = function (prompt, options) {
        return __awaiter(this, void 0, void 0, function () {
            var count, systemParts, systemPrompt, userPrompt, result;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        userPrompt = "Topic/Brief: ".concat(prompt);
                        return [4 /*yield*/, this.callAnthropic(systemPrompt, userPrompt, 0.9, 1500)];
                    case 1:
                        result = _b.sent();
    ...
    AnthropicProvider.prototype.rewriteCaption = function (text, tone) {
        return __awaiter(this, void 0, void 0, function () {
            var systemPrompt, userPrompt, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.callAnthropic(systemPrompt, userPrompt, 0.85, 1500)];
                    case 1:
                        result = _a.sent();
    ...
    AnthropicProvider.prototype.suggestHashtags = function (content) {
        return __awaiter(this, void 0, void 0, function () {
            var systemPrompt, userPrompt, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        userPrompt = "Content:\n".concat(content);
                        return [4 /*yield*/, this.callAnthropic(systemPrompt, userPrompt, 0.7, 500)];
                    case 1:
                        result = _a.sent();
     ...
     */
    AnthropicProvider.prototype.parseNumberedList = function (text, expectedCount) {
     ...
     */
    AnthropicProvider.prototype.parseHashtagResponse = function (text) {
