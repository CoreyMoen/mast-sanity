...
var OpenAIProvider = /** @class */ (function () {
    function OpenAIProvider(apiKey, model) {
        ...
        if (!apiKey) {
            throw new Error("OpenAI API key is required. Provide a valid API key from the OpenAI dashboard.");
        }
        this.apiKey = apiKey;
        this.model = model;
    }
    OpenAIProvider.prototype.callOpenAI = function (systemPrompt_1, userPrompt_1) {
        return __awaiter(this, arguments, void 0, function (systemPrompt, userPrompt, temperature, maxTokens) {
            var messages, response, error_1, errorText, data, _a, text;
            var _b, _c, _d, _e;
            ...
            return __generator(this, function (_f) {
                switch (_f.label) {
                    ...
                    case 1:
                        _f.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, fetch(OPENAI_API_URL, {
                                method: "POST",
                                headers: {
                    ...
                    case 3:
                        error_1 = _f.sent();
                        throw new Error("OpenAI API request failed: ".concat(error_1 instanceof Error ? error_1.message : "Network error"));
                    case 4:
                    ...
                    case 5:
                        errorText = _f.sent();
                        throw new Error("OpenAI API returned status ".concat(response.status, ": ").concat(errorText));
                    case 6:
                        _f.trys.push([6, 8, , 9]);
                    ...
                    case 9:
                        if (data.error) {
                            throw new Error("OpenAI API error: ".concat((_b = data.error.message) !== null && _b !== void 0 ? _b : "Unknown error"));
                        }
                        text = (_e = (_d = (_c = data.choices) === null || _c === void 0 ? void 0 : _c[0]) === null || _d === void 0 ? void 0 : _d.message) === null || _e === void 0 ? void 0 : _e.content;
                        if (!text) {
                            throw new Error("OpenAI API returned an empty response. The model may have refused the request.");
                        }
    ...
    OpenAIProvider.prototype.generateCaption = function (prompt, options) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.callOpenAI(systemPrompt, userPrompt, 0.9, 1500)];
                    case 1:
                        result = _b.sent();
    ...
    OpenAIProvider.prototype.rewriteCaption = function (text, tone) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.callOpenAI(systemPrompt, userPrompt, 0.85, 1500)];
                    case 1:
                        result = _a.sent();
    ...
    OpenAIProvider.prototype.suggestHashtags = function (content) {
        return __awaiter(this, void 0, void 0, function () {
            var systemPrompt, userPrompt, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        userPrompt = "Content:\n".concat(content);
                        return [4 /*yield*/, this.callOpenAI(systemPrompt, userPrompt, 0.7, 500)];
                    case 1:
                        result = _a.sent();
     ...
     */
    OpenAIProvider.prototype.parseNumberedList = function (text, expectedCount) {
     ...
     */
    OpenAIProvider.prototype.parseHashtagResponse = function (text) {
