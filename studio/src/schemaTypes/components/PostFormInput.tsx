...
/**
 * Custom form input for Post documents that adds a banner
 * with a link to open the post in Presentation mode.
        ...
        <Card padding={3} tone="primary" border radius={2} marginBottom={4}>
          <Flex align="center" justify="space-between" gap={3}>
            <Flex align="center" gap={2}>
              ...
              <Text size={1}>Edit this post visually in Presentation mode</Text>
            </Flex>
            <Button
