...
/**
 * Custom form input for Section Template documents that adds a banner
 * with a link to open the template preview in Presentation mode.
...
export function SectionTemplateFormInput(props: ObjectInputProps) {
  ...
  const handleClick = () => {
    ...
    // Remove 'drafts.' prefix if present for the preview URL
  ...
  // Only show banner when in Structure mode (not Presentation) and document has been saved
