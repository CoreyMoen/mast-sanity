...
function FooterLinkItem({
  ...
  const className =
    'text-body text-gray-600 transition-colors duration-300 hover:text-black hover:underline'
  ...
  return (
    <footer className="border-t border-gray-200 bg-white mt-auto">
      <div className="container py-12 md:py-16">
          ...
          {data?.linkColumns && data.linkColumns.length > 0 && (
            ...
            >
              {data.linkColumns.map((column) => (
                <div key={column._key}>
                  {column.title && (
                    <h3 className="text-h6 font-medium uppercase tracking-wider text-gray-500 mb-4">
                      {column.title}
                    </h3>
                  )}
        ...
        {/* Divider */}
        <hr className="my-8 border-gray-200 md:my-12" />
              ...
              {data.socialLinks.map((social) => (
                <li key={social._key}>
                  <a
                    ...
                    className="flex h-10 w-10 items-center justify-center text-gray-600 transition-colors duration-300 hover:text-brand"
