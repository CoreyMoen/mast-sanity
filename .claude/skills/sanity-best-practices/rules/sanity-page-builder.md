...
This guide covers **Page Builder** patterns—arrays of block objects that allow content teams to compose flexible page layouts. For Portable Text (rich text within documents), see `sanity-portable-text.md`.
...
**Note:** See `sanity-nextjs.md` for more details on `usePresentationQuery` and `sanity-visual-editing.md` for the conceptual overview.
...
_Note: For Image patterns, see `sanity-image.md`. For Portable Text patterns, see `sanity-portable-text.md`._
