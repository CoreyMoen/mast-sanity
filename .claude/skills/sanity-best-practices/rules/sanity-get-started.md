...
For advanced patterns (TypeGen, Visual Editing, `defineLive`), see `sanity-nextjs.md`.

### Step 3: Other Frameworks

For non-Next.js frameworks, read the corresponding rule file and follow its integration guide:

- **React Router / Remix:** `sanity-remix.md`
- **SvelteKit:** `sanity-svelte.md`
- **Nuxt:** `sanity-nuxt.md`
- **Astro:** `sanity-astro.md`
...
- **Visual Editing** — Click-to-edit in the Presentation tool (`sanity-visual-editing.md`)
- **TypeGen** — Type-safe queries with generated types (`sanity-typegen.md`)
- **Studio Structure** — Customize the Studio sidebar (`sanity-studio-structure.md`)
- **SEO** — Metadata, sitemaps, and Open Graph (`sanity-seo.md`)
- **i18n** — Multi-language content (`sanity-localization.md`)
